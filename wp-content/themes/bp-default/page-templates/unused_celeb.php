		...
		<?php do_action( 'template_notices' ); ?>
			...
			<div class="content-celeb">
					<?php 
							...
							if ( $username ) {
					?>
				<h2 class="title"><i class="celeb-icon4"></i><?php echo $username;?></h2>
				<br class="clear"/>
				<div class="wr-celeb">
					<section class="latest-celebs">
						<?php $posts = new WP_Query( array( 'post_type' => 'celebcook', 'author_name' => $username, 'post_status' => 'publish', 'posts_per_page'=> 4, 'orderby' => 'post_date', 
												'order' => 'DESC' ));
											if ( $posts->have_posts() ) :			
												$count = 1; 
														...
														<div class="celeb-img">
															...
															<?php global $wpdb;
															 ...
															 foreach($results as $result){?>
																<img src="<?php echo $result->VALUE;?>" width="333"/>
															 <?php } ?>	
														</div>
														<?php endif; ?>
																...
																<?php
																 ...
																 <div class="box-t-celeb" style="border:2px solid <?php echo $randomColor;?>">
																	...
																	<ul class="celeb-info">
																		...
																		<li><label for="meal" class="celeb-meal">มื้อ</label><span>
						...
						<section style="width: 1040px; margin: 0 auto;">
								<ul class="grid effect-3" id="grid">
									<?php	$posts = new WP_Query( array( 'post_type' => 'celebcook', 'author_name' => $username, 'post_status' => 'publish', 'orderby' => 'post_date', 
															'order' => 'DESC' ));
											if ( $posts->have_posts() ) :			
												$count = 0; 
												while ( $posts->have_posts() ) : $posts->the_post(); 
																 ...
																 <div class="box-image" style="border:2px solid <?php echo $randomColor;?>">
																	...
																	<div class="celeb-info-lazy">
																		...
																		<div>
																			...
																			<span><?php 	$ccv = get_post_meta( get_the_ID(), 'check_meal', true ); 
