...
<main id="content" >
		<div class="social">
         	<li><a href="https://twitter.com/Foodsawasdee" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/_inc/images/tw-icon.png"></a></li>
          	<li><a href="https://www.facebook.com/foodsawasdee" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/_inc/images/fb-icon.png"></a></li>
            <li><a href="#" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/_inc/images/yt-icon.png"></a></li>
            <li><a href="https://instagram.com/foodsawasdee" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/_inc/images/ig-icon.png"></a></li>
         </div>
            ...
            <div class="content-section-1">
				 ...
				 <h2 class="title varity-icon">วาไรตี้ร้านอร่อย</h2>
                    ...
                    <section class="review-by-user">
                    	<ul>
							<?php 
								$variety = new WP_Query( array('post_type' => 'recommended', 'posts_per_page' => '2', 'post_status' => 'publish','orderby'=>'modified' ,'order' => 'DESC') );
                    ...
                    <section class="review-by-admin">
						...
						<?php 
								...
								$variety_sticky = new WP_Query( array('post_type' => 'recommended', 'posts_per_page' => '1', 'post_status' => 'publish','orderby'=>'modified' ,'order' => 'DESC','offset' => '2' ));
                    ...
                    <div class="box-l">
                        <section class="recipe-by-celeb">
                        	<ul>
							<?php 
								$celebcook = new WP_Query( array('post_type' => 'celeb-cooking', 'posts_per_page' => '1', 'post_status' => 'publish') );
                    ...
                    <div class="box-r">
                        ...
                        <section class="recipe-by-user">
                        	<ul>
							<?php 
								$recipe = new WP_Query( array('post_type' => 'cooking', 'posts_per_page' => '2', 'post_status' => 'publish') );
        ...
        <div  class="content-section-2">
        		...
        		<div class="box-l">
                    ...
                    <section class="trend-zone">
                    	<ul>
							<?php 
								$trend_zone = new WP_Query( array('post_type' => 'articles', 'posts_per_page' => '1', 'post_status' => 'publish') );
        ...
        <div class="content-section-3">
        	<div class="box-l">
        		<section class="tiptechnique">
                    	<ul>
						<?php 
								$likesara = new WP_Query( array('post_type' => 'articles', 'posts_per_page' => '2', 'post_status' => 'publish') );
