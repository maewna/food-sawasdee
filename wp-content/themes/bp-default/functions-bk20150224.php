...
function render_checkbox_meal( $form_id, $post_id, $form_settings ) {
        $checkfield1 = get_post_meta($post_id, '_my_meta_check_field1', true);
		$checkfield2 = get_post_meta($post_id, '_my_meta_check_field2', true);
		$checkfield3 = get_post_meta($post_id, '_my_meta_check_field3', true);
		$checkfield4 = get_post_meta($post_id, '_my_meta_check_field4', true);				
    ?>
...
function update_checkbox_meal( $post_id ) {   
	...
	update_post_meta( $post_id, '_my_meta_check_field1', $checkdata1 ); 
	update_post_meta( $post_id, '_my_meta_check_field2', $checkdata2 );  
	update_post_meta( $post_id, '_my_meta_check_field3', $checkdata3 );  
	update_post_meta( $post_id, '_my_meta_check_field4', $checkdata4 );  	
}
		...
		<div class="starRating">
			<div>
				<div>
					<div>
						<div>
							<input  type="radio" name="point_rate" value="1">
				...
				<input type="radio" name="point_rate" value="4">
				<label for="rating4"><span>4</span></label>
			</div>
			<input type="radio" name="point_rate" value="5">
...
function render_enviRating( $form_id, $post_id, $form_settings ) {
    ...
    <div class="wpuf-fields">
		<div class="smileRating">
			<div>
				<div>
					<input  type="radio" name="envi_rating" value="1">
					<label for="rating1"><span>1</span></label>
				</div>
				<input  type="radio" name="envi_rating" value="2">
				<label for="rating2"><span>2</span></label>
			</div>
			<input  type="radio" name="envi_rating" value="3">
			<label for="rating3"><span>3</span></label>
		</div>
    </div>
    <?php
...
function render_tasteRating( $form_id, $post_id, $form_settings ) {
    ...
    <div class="wpuf-fields">
		<div class="smileRating">
			<div>
				<div>
					<input  type="radio" name="taste_rating" value="1">
					<label for="rating1"><span>1</span></label>
				</div>
				<input type="radio" name="taste_rating" value="2">
				<label for="rating2"><span>2</span></label>
			</div>
			<input  type="radio" name="taste_rating" value="3">
			<label for="rating3"><span>3</span></label>
		</div>
    </div>
    <?php
...
function render_worthinessRating( $form_id, $post_id, $form_settings ) {
    ...
    <div class="wpuf-fields">
		<div class="smileRating">
			<div>
				<div>
					<input  type="radio" name="worthiness_rating" value="1">
					<label for="rating1"><span>1</span></label>
				</div>
				<input type="radio" name="worthiness_rating" value="2">
				<label for="rating2"><span>2</span></label>
			</div>
			<input  type="radio" name="worthiness_rating" value="3">
			<label for="rating3"><span>3</span></label>
		</div>
    </div>
    <?php
		...
		<div class="priceRate">
			<div>
				<div>
					<div>
						<div>
							<input  type="radio" name="price_rate" value="1">
							<label for="rating1"><span>1</span></label>
						</div>
						<input type="radio" name="price_rate" value="2">
						<label for="rating2"><span>2</span></label>
					</div>
					<input type="radio" name="price_rate" value="3">
					<label for="rating3"><span>3</span></label>
				</div>
				<input type="radio" name="price_rate" value="4">
				<label for="rating4"><span>4</span></label>
			</div>
			<input type="radio" name="price_rate" value="5">
			<label for="rating5"><span>5</span></label>
		</div>
    </div>
    <?php
...
function render_credit( $form_id, $post_id, $form_settings ) {
    ...
    <div class="wpuf-fields">
		<input type="radio" name="bistro_credit" value="have"/>
		<label >มี</label>
		<input type="radio" name="bistro_credit" value="haveno"/>
		<label >ไม่มี</label>
    </div>
    <?php
}
...
function render_parking( $form_id, $post_id, $form_settings ) {
    ...
    <div class="wpuf-fields">
		<input type="radio" name="bistro_parking" value="have"/>
		<label >มี</label>
		<input type="radio" name="bistro_parking" value="haveno"/>
		<label >ไม่มี</label>
    </div>
    <?php
}
...
function render_internet( $form_id, $post_id, $form_settings ) {
    ...
    <div class="wpuf-fields">
		<input type="radio" name="bistro_internet" value="have"/>
		<label >มี</label>
		<input type="radio" name="bistro_internet" value="haveno"/>
		<label >ไม่มี</label>
    </div>
    <?php
}
...
function render_alcohol( $form_id, $post_id, $form_settings ) {
    ...
    <div class="wpuf-fields">
		<input type="radio" name="bistro_alcohol" value="have"/>
		<label >มี</label>
		<input type="radio" name="bistro_alcohol" value="haveno"/>
		<label >ไม่มี</label>
    </div>
    <?php
}
