...
<script type="text/javascript">
			...
			$(document).ready(function(){
				$('#more-friends').click(function(){
					$('#lbcontent').html('<iframe src="<?php echo get_template_directory_uri(); ?>/formSearchUser.php?u=<?php echo bp_displayed_user_id()?>" style="width: 635px; height: 545px;"></iframe>');
