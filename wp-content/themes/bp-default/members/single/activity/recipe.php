...
<div class="prof-left-1 align-left">
        	...
        	<section class="member-activities">	
				...
				<?php 
				global $wpdb;
				$posts = $wpdb->get_results("SELECT * FROM $wpdb->posts WHERE post_author='".bp_displayed_user_id()."' AND ( post_type='recipes' OR post_type='celebcook' ) AND post_status='publish' ORDER BY post_date DESC");
				if($posts){ ?>
