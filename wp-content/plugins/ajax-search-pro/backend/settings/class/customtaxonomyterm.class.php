      ...
      <div class='wpdreamsCustomTaxonomyTerm'>
        <fieldset>                               
          ...
          <legend>" . $this->label . "</legend>";
            ...
            <p>Available terms for the selected taxonomy</p><ul id="sortable' . self::$_instancenumber . '" class="connectedSortable">';
                ...
                (function ($) {
                    $(document).ready(function () {
                        ...
                        $("#<?php echo $this->name; ?>_taxonomies").change(function () {
                            ...
                            $("li", "#sortable<?php echo self::$_instancenumber ?>").css('display', 'none').addClass('hiddend');
                            $("li[taxonomy=" + taxonomy + "]", "#sortable<?php echo self::$_instancenumber ?>").css('display', 'block').removeClass('hiddend');
                        });
                        ...
                        $("#sortablecontainer<?php echo self::$_instancenumber ?> .arrow-all-right").click(function(){
                            $("#sortable<?php echo self::$_instancenumber ?> li:not(.hiddend)")
