...
if ( ! class_exists( 'wp_ulike' ) ) {
	...
	class wp_ulike{
		...
		public function get_template($id,$method,$liked,$num1,$num2){
			...
			return array(
				"like_img" 				=> '<a data-ulike-id="'.$id.'" data-ulike-type="'.$method.'" data-ulike-status="'.$status.'" class="wp_ulike_btn image" style="border:none;"></a>'.$counter.'',
				"like_text" 			=> '<a data-ulike-id="'.$id.'" data-ulike-type="'.$method.'" data-ulike-status="'.$status.'" class="wp_ulike_btn text" style="border:none;">'.$button_text.'</a>'.$counter.'',
				"text_after_like" 		=> '<a data-ulike-id="'.$id.'" data-ulike-type="'.$method.'" data-ulike-status="'.$status.'" class="wp_ulike_btn text" style="border:none;">'.$text_after_like.'</a>'.$counter.'',
				"text_after_unlike" 	=> '<a data-ulike-id="'.$id.'" data-ulike-type="'.$method.'" data-ulike-status="'.$status.'" class="wp_ulike_btn text" style="border:none;">'.$text_after_unlike.'</a>'.$counter.'',
				"permission_text" 		=> '<a title="'.$permission_text.'" class="text user-tooltip" style="border:none;">'.$text_after_like.'</a>'.$counter.'',
				"permission_img" 		=> '<a title="'.$permission_text.'" class="image user-tooltip" style="border:none;"></a>'.$counter.'',
				"login_img" 			=> '<a title="'.$login_text.'" class="image user-tooltip" style="border:none;"></a>'.$counter.'',				
				"login_text" 			=> '<a title="'.$login_text.'" class="text user-tooltip" style="border:none;">'.$button_text.'</a>'.$counter.''				
			);
		}		
