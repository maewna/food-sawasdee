					...
					<td valign="top">
						<div id='mapp_left_panel'>
							<div id='mapp_maplist_panel'>
								<p>
									<b><?php _e('Create Maps', 'mappress')?></b>
										...
										<div id='mapp_add_panel' style='visibility:hidden'>
											<p>
												<span  id='mapp_add_address'>
													...
													<input type='text' id='mapp_saddr' style="width: 195px;" />
												</span>
												<span class='submit' style='padding: 0; float: none;' >
													<input class='button-primary' type='button' id='mapp_add_btn' value='<?php _e('Add', 'mappress'); ?>' style='float:right;'>
												</span>
