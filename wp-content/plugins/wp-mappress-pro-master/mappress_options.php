...
class Mappress_Settings {
    ...
    function admin_menu() {
        // Add menu
        $pagehook = add_options_page('Map', 'MapPress', 'manage_options', 'mappress', array(&$this, 'options_page'));        
    ...
    */
    ...
    function metabox_demo($object, $metabox) {                           
        $poi = new Mappress_Poi(array("title" => sprintf("<a href='http://www.wphostreviews.com/mappress'>%s</a>", __("Map", 'mappress')), "body" => "", "address" => "California"));
        $poi->geocode();
        $pois = array($poi);
