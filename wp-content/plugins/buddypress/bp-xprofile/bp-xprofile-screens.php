...
function xprofile_screen_change_avatar() {
	...
	bp_core_load_template( apply_filters( 'xprofile_template_change_avatar', 'members/single/avatar' ) );
}
 ...
 * @uses bp_core_load_template() Looks for and loads a template file within the current member theme (folder/filename)
 */
function xprofile_screen_shout_box() {
	...
	do_action( 'xprofile_screen_shout_box' );
	bp_core_load_template( apply_filters( 'xprofile_template_shout_box', 'members/single/profile/shout-box' ) );
}
